...
<div class="relative w-full h-screen z-0">
    ...
    <section class="bg-white dark:bg-white-900 mt-5">
        <div class="gap-16 items-center py-5 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-12 lg:px-6">
            ...
            <div class="mb-28 mt-4">
                <img class="w-[900px] h-96 rounded-lg" src="{{ asset('images/home/about-01.jpg')}}" alt="office content 1">
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-white-900 mt-5">
        <div class="gap-16 items-center py-5 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-12 lg:px-6">
            <div class="mb-28 mt-4">
                <img class="w-[900px] h-96 rounded-lg" src="{{ asset('images/home/businesses.jpg') }}" alt="office content 1">
            </div>
            <div class="font-light text-black-500 sm:text-lg dark:text-black-400">
                ...
                <a href="/overview"><button type="button" class="text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">See More</button></a>
            </div>
    ...
    <section class="bg-white dark:bg-white-900 mt-5">
        <div class="gap-16 items-center py-5 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-12 lg:px-6">
            ...
            <div class="mb-28 mt-4">
                <img class="w-[900px] h-96 rounded-lg" src="{{ asset('images/home/partners.jpg')}}" alt="office content 1">
            </div>
        </div>
    </section>
    ...
    <section class="bg-white dark:bg-white-900 mt-5">
        <div class="gap-16 items-center py-5 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-12 lg:px-6">
            <div class="mb-28 mt-4">
                <img class="w-[900px] h-96 rounded-lg" src="{{ asset('images/home/hiring.jpg') }}" alt="office content 1">
            </div>
            <div class="font-light text-black-500 sm:text-lg dark:text-black-400">
